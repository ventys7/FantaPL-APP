        ...
        <div className="h-[100dvh] overflow-hidden relative isolate w-full flex flex-col items-center justify-center p-4">
            ...
            <div className="flex flex-col items-center justify-center space-y-3 md:space-y-6 z-10 w-full max-w-4xl px-4">
                ...
                <div className="animate-fade-in">
                    <span className="inline-flex items-center px-3 py-1 md:px-6 md:py-2 rounded-full bg-white/5 border border-white/10 text-xs md:text-base font-medium text-pl-teal backdrop-blur-sm shadow-lg">
                        Season 25/26
                    </span>
                </div>
                ...
                <div className="animate-fade-in relative flex-shrink-0">
                    <img
                        src={logo}
                        alt="FantaPL Logo"
                        className="w-24 md:w-64 h-auto drop-shadow-[0_0_25px_rgba(0,255,133,0.3)] hover:scale-105 transition-transform duration-500"
                    />
                </div>
                ...
                <div className="animate-slide-up flex flex-col items-center text-center space-y-1 md:space-y-2">
                    <div className="space-y-0">
                        <h2 className="text-2xl md:text-6xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-pl-teal to-pl-pink drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">
                            Fantacalcio
                        </h2>
                        <h1 className="text-xl md:text-5xl font-bold text-white tracking-widest uppercase">
                            Premier League
                        </h1>
                    </div>

                    <div className="mt-1 md:mt-4 max-w-xs md:max-w-2xl mx-auto">
                        <p className="text-xs md:text-xl text-gray-300 font-light italic leading-tight">
